...
document.getElementById('login-form').addEventListener('submit', function (e) {
    ...
    switch (userType) {
        case 'user':
            window.location.href = 'user1.html'; // Redirect to the user page
            break;
        case 'vendor':
            window.location.href = 'vendor1.html'; // Redirect to the vendor page
            break;
        case 'admin':
            window.location.href = 'admin1.html'; // Redirect to the admin page
            break;
        default:
